          ...
          <div class="w-full max-w-xl">
            <div class="flex gap-4 items-center justify-center flex-col md:flex-row">
              <template v-if="step == 1">
                ...
                <div class="w-full">
                  <input type="text" class="bg-white p-4 text-black rounded text-lg w-full text-center md:text-left" placeholder="Введите телефон" v-mask="'+ #(###) ###-##-##'" v-model="phone" inputmode="numeric">
                </div>
                <div class="w-full">
                  <button
              ...
              <template v-if="step == 2">
                ...
                <div class="w-full">
                  <input type="text" class="bg-white p-4 text-black rounded text-lg w-full text-center md:text-left" placeholder="Введите телефон" v-mask="'+# (###) ###-##-##'" v-model="phone" readonly inputmode="numeric">
                </div>
                <div class="w-full">
