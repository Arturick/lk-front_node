        ...
        <div class="bg-white rounded-3xl mt-2.5 mx-2.5 p-7 pb-20">
            ...
            <div class=" flex gap-8 items-center">
                <ul class="breadcrumbs">
                    <li class="breadcrumbs__item">
                        <nuxt-link to="/" class="but but_3 p-2.5">Назад</nuxt-link>
                    </li>
                    <li class="breadcrumbs__item">
                ...
                <div class="flex gap-4 items-center  flex-col md:flex-row">
                    <div class="w-full md:w-auto">
                        <div class="input-block">
                            <input type="text" name="name" class="input-block__input input-block__input_w py-4 px-7" placeholder="Введите артикул">
                        </div>
                    </div>
                    ...
                    <div class="w-full md:w-auto">
                        <nuxt-link to="/ransoms/ransoms_4" class="but but_1 py-4 px-7">Заказать</nuxt-link>
                    </div>
                    <div class="w-full md:w-auto">
                        <a href="#" class="but but_3 py-4 px-7">В черновики</a>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-12">
                <div class="positions-table">
                    <table class="positions-table__max">
                        <thead>
                            <tr>
                                <th>Фото</th>
                                <th>Бренд</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="input-block" style="width: 150px;">
                                        <input type="text" name="name" class="input-block__input input-block__input_w_1 py-2 px-4" value="">
                                    </div>
                                </td>
                                <td>
                                    <div class="select">
                                ...
                                <td>
                                    <div class="input-block">
                                        <input type="text" name="name" class="input-block__input input-block__input_w_1 py-2 px-4" value="21.08.2022">
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-block">
                                        <input type="text" name="name" class="input-block__input input-block__input_w_1 py-2 px-4" value="22.08.2022">
                                    </div>
                                </td>
                                <td>
                                    <a href="#"><i class="icon icon_copy"></i></a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-block">
                                        <input type="text" name="name" class="input-block__input input-block__input_w_1 py-2 px-4" value="23.08.2022">
                                    </div>
                                </td>
                                <td>
                                    <a href="#"><i class="icon icon_copy"></i></a>
